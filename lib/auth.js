...
//
// No exige email verificado: mientras Resend esté en modo sandbox (sin
// dominio propio verificado) solo puede entregar correos a la cuenta
// propietaria, así que bloquear el acceso hasta verificar dejaría fuera a
// cualquier cliente real sin ninguna forma de entrar. El signup ya avisa si
// el email de verificación no se pudo enviar, y Ajustes permite reenviarlo.
export async function requireBusiness(req) {
  ...
  if (await isTrialExpired(decoded.userId)) {
